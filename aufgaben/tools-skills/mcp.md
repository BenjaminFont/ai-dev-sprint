...
1. Melde dich bei https://context7.com/dashboard an und erstelle einen kostenlosen API-Key.
2. Öffne ein Spring-Boot-Projekt, starte ein Terminal und verbinde den MCP-Server mit dem Projekt.
3. Schreibe zwei Prompts je nach Voraussetzung. Wenn du die latest stable Spring Boot Version nicht im Einsatz hast, dann a. Wenn du schon so weit bist, dann b.

3. a. Nutze Context7, um die aktuellste Dokumentation zur neuesten stabilen Spring-Boot-Version abzurufen, und erstelle eine Bewertung, was nötig wäre, um zu
